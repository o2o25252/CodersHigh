...
class QuestionViewController: UIViewController {
    ...
    func updateUI() { // 문제에 맞게 업데이트
        ...
        //제목 변경하기 0 부터 ( ? 근데 이 거 어떻게 초기화 시켜?)
        navigationItem.title = "Question #\(questionIndex + 1)"
        
        // 세팅
        let currentQuestion = questions[questionIndex]// 현재 문제는 = 문제들중 현재 순서의 문제 를 가져온다 .
        ...
        switch currentQuestion.type { //ResponseType ( 그닌깐 싱글 타입이냐 ? 그런거)
        case .sigle:
